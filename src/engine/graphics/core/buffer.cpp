...
namespace graphics {
	...
	Buffer::Buffer(Type _type, GLuint _elementSize, GLuint _numElements, Usage _usageBits, const GLvoid *_data) : m_tbID(0),
																																																								m_type(_type),
	...
	Buffer::Buffer(Type _type, GLuint _elementSize, GLuint _numElements, TextureFormat _format, Usage _usageBits, const GLvoid *_data) : Buffer(_type, _elementSize, _numElements, _usageBits, _data) {
	...
	Buffer::Buffer(Buffer &&_rhs) : m_id(_rhs.m_id),
																	m_tbID(_rhs.m_tbID),
																	m_type(_rhs.m_type),
																	m_size(_rhs.m_size),
