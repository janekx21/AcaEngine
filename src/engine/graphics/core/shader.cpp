...
namespace graphics {
	...
	void Program::setUniform(int _location, const std::vector<glm::vec3> &values) {
		glCall(glProgramUniform3fv, m_programID, _location, values.size(), (const float *) values.data());
	}
